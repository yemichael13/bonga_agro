...
const Navbar = () => {
  ...
  return (
    <div 
      className={`fixed top-0 left-0 w-full z-50 flex justify-between items-center bg-white h-20  px-4 transition-opacity duration-300 ${navbarHovered ? 'opacity-100' : 'md:opacity-100'}`}
